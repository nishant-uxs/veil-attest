...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerAttestation: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`registerAttestation: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerAttestation',
                                     'argument 1 (as invoked from Typescript)',
                                     'veil-attest.compact line 31 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._registerAttestation_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      getAttestationCount: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getAttestationCount: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getAttestationCount',
                                     'argument 1 (as invoked from Typescript)',
                                     'veil-attest.compact line 39 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._getAttestationCount_0(context, partialProofData);
      ...
      getLatestCommitment: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getLatestCommitment',
                                     'argument 1 (as invoked from Typescript)',
                                     'veil-attest.compact line 44 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
    ...
    this.impureCircuits = {
      ...
      getAttestationCount: this.circuits.getAttestationCount,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('getAttestationCount', new __compactRuntime.ContractOperation());
  ...
  _privateClaim_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('privateClaim',
                                 'return value',
                                 'veil-attest.compact line 20 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _registerAttestation_0(context, partialProofData) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('veil-attest.compact line 35 char 23: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _getAttestationCount_0(context, partialProofData) {
