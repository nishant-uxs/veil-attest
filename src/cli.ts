/**
 * CLI for interacting with mn-hello contract
 */
...
// the same private state. The veil-attest contract has no witnesses (empty state).
      ...
      switch (choice.trim()) {
        ...
        case '2': {
          ...
          try {
            ...
            if (contractState) {
              const ledgerState = VeilAttest.ledger(contractState.data);
